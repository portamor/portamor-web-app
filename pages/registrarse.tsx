    ...
    <>
      <Box sx={{ width: "100%" }}>
        ...
        {activeStep === steps.length ? (
          ...
          <React.Fragment>
            {activeStep === 0 ? <FormRegister handleSkip={handleSkip} /> : <LoginForm repeatPasswordOption={true} />}
            <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "center", pt: 2 }}>
              <Button color="primary" disabled={activeStep === 0} onClick={handleBack} sx={{ mr: 2 }}>
                Regresar Atrás
              </Button>
            </Box>
          </React.Fragment>
