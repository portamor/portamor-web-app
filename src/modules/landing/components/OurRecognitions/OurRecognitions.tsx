...
export const OurRecognitions: React.FC = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      /*content: "Finalistas a nivel nacional del evento más importante y de mayor exposición sobre el emprendimiento social en el Perú",*/
      urlImage: ojo1.src,
      knowMore: "https://ojo.pe/mujer/portamor-una-plataforma-que-promueve-el-envejecimiento-activo-y-saludable-web-ojo-noticia/"
    },
    {
      ...
      /*content: "Finalistas a nivel nacional del evento más importante y de mayor exposición sobre el emprendimiento social en el Perú",*/
      urlImage: ojo2.src,
      knowMore: "http://www.newsmonitor.biz/Viewer/postview.aspx?CLI=137&PAU=4829338&CLIP=3562982&AspxAutoDetectCookieSupport=1"
    },
    {
      ...
      knowMore: "https://busquedas.elperuano.pe/normaslegales/otorgan-el-reconocimiento-nacional-de-buenas-practicas-de-vo-resolucion-ministerial-n-332-2022-mimp-2131433-1/"
    },
    {
      title: "Emprende UP",
      subtitle: "Otorgan el Reconocimiento Nacional de Buenas Prácticas de Voluntariado, Edición 2022",
    ...
    },
    {
      ...
      knowMore: "https://www.facebook.com/UPTIncuba/posts/pfbid0vr26fdziP3RWAaqY3afDQwr8qxd7i4E5UddubC7GxQ3UVXMGFsdQP2VYW45YqZPpl"
    },
    {
    ...
    },
    {
      ...
      knowMore: "https://ojo.pe/ciudad/portamor-la-escuela-de-bienestar-integral-que-empodera-a-adultos-mayores-noticia/"
    },
    {
          ...
          {items.map((item, index) => (
            <div key={index}>
              <Card sx={{ maxWidth: 345 }}>
                ...
                <CardActions>
                  <Button size="small" onClick={() => window.open(item.knowMore, "_blank")}>Saber más</Button>
                </CardActions>
              </Card>
            </div>
          ))}
