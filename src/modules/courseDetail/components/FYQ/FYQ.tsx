  ...
  return (
    <div>
      <Accordion className={styles["course-accordion"]}>
        <AccordionSummary style={{ backgroundColor: "#ffffff" }} expandIcon={<ExpandMoreIcon />}>
          <div className={styles["course-accordion-summary-content"]}>
            <h2>¿Tengo acceso ilimitado a las clases?</h2>
          </div>
        </AccordionSummary>
        <span className={styles["answer"]}>
          ¡Sí! Luego de que te inscribas al curso vas a poder acceder a las clases cuando y donde quieras. El curso se
          queda en tu cuenta.
        </span>
      </Accordion>
      ...
      <Accordion className={styles["course-accordion"]}>
        ...
        Todo el contenido es 100% en línea, con clases pregrabadas a las que tendrás acceso luego de la compra del
        curso. ¡Puedes iniciarlo y desarrollarlo a tu propio ritmo!
      </Accordion>
