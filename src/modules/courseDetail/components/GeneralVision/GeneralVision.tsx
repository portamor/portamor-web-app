    ...
    <>
      <div className={styles["course-detail-info-container"]}>
        <div className={styles["course-detail-info"]}>
          <Button variant="contained" color="primary" onClick={handleClickOpen} disabled={isUpdating}>
            {user.isLoggedIn
        ...
        <div className={styles["certificate-portamor"]}>
          ...
          <div className={styles["certificate-portamor-container"]}>
            <Image src={certificate} alt="certificate detail" width={300} className={styles["certificate-img"]} />
            <p>
              “Al final del curso podrás descargar un certificado virtual que acredite que has lo has finalizado con
              éxito”
            </p>
          </div>
        </div>
        <div className={styles["description-portamor-main"]}>
          <div className={styles["description-portamor"]}>
            <h2>PORTAMOR</h2>
            <p>
              Somos una Comunidad que empodera al adulto mayor por un envejecimiento activo y saludable a través de
              nuestra plataforma interactiva de aprendizaje integral.
            </p>

            <h2>METODOLOGIA</h2>
            <p>
              Los cursos serán desarrollados sobre la base de una metodología interactiva que promueve el
              autoaprendizaje y el trabajo colaborativo, complementada con presentaciones del especialista de cada
              sesión.
            </p>
          </div>
        </div>
      ...
      <div className={styles["course-card-container"]}>
        <CourseDetailCard image={courseDetail.image} courseId={courseId} />
      </div>
    </>
  )
}
